      ...
      <div className="max-w-2xl">
        ...
        <div className="mt-6 bg-white rounded-xl border border-gray-200 p-6">
          ...
          <div className="space-y-2">
            {[
              { label: "Fee Reminder", text: "Dear Parent, your child's monthly fee is due. Please pay at the earliest to avoid late charges. - EduManage BD" },
              { label: "Holiday Notice", text: "Dear Parent, please note that classes will be closed on [DATE] due to [REASON]. Regular classes will resume on [DATE]. - EduManage BD" },
              { label: "Exam Notice", text: "Dear Parent, the upcoming exam is scheduled for [DATE]. Please ensure your child is prepared. - EduManage BD" },
            ].map((t, i) => (
