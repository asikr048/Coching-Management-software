...
import { User, Phone, Mail, MapPin, BookOpen, CreditCard, Calendar, Fingerprint, AlertCircle, CheckCircle } from "lucide-react"
...
export default async function StudentDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const [enrollments, payments, attendance, results, duesRes] = await Promise.all([
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
        ...
        <div className="bg-white rounded-2xl border border-slate-200/90 shadow-sm p-4 text-center shadow-xl col-span-2 md:col-span-1">
