      ...
      <nav className="fixed top-0 w-full bg-white/70 backdrop-blur-xl border-b border-gray-100/80 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-2">
            ...
            <Link href="/enroll" className="px-5 py-2.5 text-sm font-semibold bg-gray-900 text-white rounded-xl hover:bg-gray-800 shadow-sm hover:shadow-md transition-all">Enroll Now</Link>
          </div>
        </div>
      </nav>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
            <div className="lg:col-span-5 space-y-8 pt-12 lg:pt-0">
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-[3.5rem] font-extrabold text-gray-900 leading-[1.1] tracking-tight">
                Where Students
                <span className="block mt-1 bg-gradient-to-r from-indigo-600 via-violet-600 to-purple-600 bg-clip-text text-transparent">Become Achievers</span>
              </h1>
              <p className="text-lg text-gray-500 leading-relaxed max-w-md">Rajshahi&apos;s most trusted coaching center. Structured batches, expert faculty, and a track record that speaks for itself.</p>
              <div className="flex flex-col sm:flex-row gap-3">
                <Link href="/enroll" className="group px-7 py-3.5 bg-gray-900 text-white rounded-xl font-semibold hover:bg-gray-800 shadow-lg shadow-gray-900/10 transition-all flex items-center justify-center gap-2">
                  Start Learning <ArrowRight className="w-4 h-4 group-hover:translate-x-0.5 transition-transform" />
                </Link>
                <a href="#batches" className="px-7 py-3.5 bg-white text-gray-700 border border-gray-200 rounded-xl font-semibold hover:border-gray-300 transition-all flex items-center justify-center gap-2">
              ...
              <div className="flex items-center gap-4 pt-2">
                <div className="flex -space-x-2">
                  {[0,1,2,3].map(i => (
                    <div key={i} className={`w-8 h-8 rounded-full border-2 border-white ${["bg-indigo-400","bg-violet-400","bg-pink-400","bg-amber-400"][i]} flex items-center justify-center text-white text-xs font-bold`}>
                      {["A","R","S","M"][i]}
                    </div>
                  ))}
                </div>
            ...
            <div className="lg:col-span-7 relative min-h-[480px] lg:min-h-[560px]">
              <div className="absolute top-8 right-0 lg:right-[-20px] w-[85%] lg:w-[80%] bg-white rounded-3xl border border-gray-100 shadow-2xl shadow-gray-200/60 overflow-hidden">
                ...
                <div className="p-5 space-y-3">
                  <div className="flex items-center justify-between py-2.5 px-3 bg-emerald-50 rounded-xl">
                    <div className="flex items-center gap-2"><div className="w-8 h-8 bg-emerald-100 rounded-lg flex items-center justify-center"><TrendingUp className="w-4 h-4 text-emerald-600" /></div><div><p className="text-sm font-medium text-gray-800">Attendance Rate</p><p className="text-xs text-gray-500">This week</p></div></div>
                  ...
                  <div className="flex items-center justify-between py-2.5 px-3 bg-indigo-50 rounded-xl">
                    <div className="flex items-center gap-2"><div className="w-8 h-8 bg-indigo-100 rounded-lg flex items-center justify-center"><Users className="w-4 h-4 text-indigo-600" /></div><div><p className="text-sm font-medium text-gray-800">New Enrollments</p><p className="text-xs text-gray-500">Last 30 days</p></div></div>
                  ...
                  <div className="flex items-center justify-between py-2.5 px-3 bg-violet-50 rounded-xl">
                    <div className="flex items-center gap-2"><div className="w-8 h-8 bg-violet-100 rounded-lg flex items-center justify-center"><Star className="w-4 h-4 text-violet-600" /></div><div><p className="text-sm font-medium text-gray-800">Exam Pass Rate</p><p className="text-xs text-gray-500">GPA 4.0+</p></div></div>
              ...
              <div className="absolute bottom-4 left-0 lg:left-[-10px] z-10 bg-white rounded-2xl border border-gray-100 shadow-xl shadow-gray-200/50 p-4 w-[220px]">
                <div className="flex items-center gap-3 mb-3">
                  <div className="w-10 h-10 bg-gradient-to-br from-amber-400 to-orange-500 rounded-xl flex items-center justify-center shadow-lg shadow-amber-200"><Shield className="w-5 h-5 text-white" /></div>
                  <div><p className="text-sm font-bold text-gray-900">Trusted</p><p className="text-xs text-gray-500">Since 2018</p></div>
                </div>
              ...
              <div className="absolute top-0 left-4 lg:left-0 z-10 bg-white rounded-2xl border border-gray-100 shadow-lg shadow-gray-200/40 px-4 py-3">
                <div className="flex items-center gap-2"><div className="w-3 h-3 bg-emerald-400 rounded-full animate-pulse" /><span className="text-sm font-semibold text-gray-800">{batches.length || "10+"} Active Batches</span></div>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              ...
              <div key={i} className="text-center group">
                <div className="w-12 h-12 bg-white border border-gray-200 rounded-2xl flex items-center justify-center mx-auto mb-3 shadow-sm group-hover:shadow-md group-hover:border-indigo-200 transition-all"><f.icon className="w-5 h-5 text-indigo-600" /></div>
      ...
      <section id="batches" className="py-24 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4 mb-12">
            ...
            <Link href="/enroll" className="inline-flex items-center gap-2 text-sm font-semibold text-indigo-600 hover:text-indigo-700 transition-colors whitespace-nowrap">View All <ArrowRight className="w-4 h-4" /></Link>
          </div>
                ...
                <Link key={batch.id} href={`/batch/${batch.id}`} className="group relative bg-white rounded-2xl border border-gray-200 overflow-hidden hover:border-indigo-300 hover:shadow-xl hover:shadow-indigo-100/50 transition-all duration-300">
                  ...
                  <div className="p-6">
                    <div className="flex items-start justify-between mb-4">
                      <div><h3 className="text-lg font-bold text-gray-900 group-hover:text-indigo-700 transition-colors">{batch.name}</h3><p className="text-sm text-gray-500 mt-0.5">{batch.subject || "General"} • {batch.class_level || "All Levels"}</p></div>
                    ...
                    <div className="space-y-2.5 mb-5">
                      <div className="flex items-center gap-2 text-sm text-gray-600"><Users className="w-4 h-4 text-gray-400" /><span>{batch.teacher?.name || "Expert Teacher"}</span></div>
                      {batch.schedule_days && <div className="flex items-center gap-2 text-sm text-gray-600"><Calendar className="w-4 h-4 text-gray-400" /><span>{batch.schedule_days}</span></div>}
                      {batch.schedule_time && <div className="flex items-center gap-2 text-sm text-gray-600"><Clock className="w-4 h-4 text-gray-400" /><span>{batch.schedule_time}</span></div>}
                    </div>
              ...
              <div className="bg-gradient-to-br from-indigo-500 to-violet-600 rounded-3xl p-8 text-white relative overflow-hidden">
                ...
                <div className="relative space-y-6">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="bg-white/10 rounded-2xl p-4 text-center backdrop-blur"><p className="text-2xl font-bold">{studentCount || "500"}+</p><p className="text-white/70 text-xs mt-1">Students Enrolled</p></div>
                    <div className="bg-white/10 rounded-2xl p-4 text-center backdrop-blur"><p className="text-2xl font-bold">20+</p><p className="text-white/70 text-xs mt-1">Expert Teachers</p></div>
                    <div className="bg-white/10 rounded-2xl p-4 text-center backdrop-blur"><p className="text-2xl font-bold">{batches.length || "10"}+</p><p className="text-white/70 text-xs mt-1">Active Batches</p></div>
                    <div className="bg-white/10 rounded-2xl p-4 text-center backdrop-blur"><p className="text-2xl font-bold">7+</p><p className="text-white/70 text-xs mt-1">Years Teaching</p></div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-5xl mx-auto relative">
          <div className="bg-gray-900 rounded-[2rem] p-12 md:p-16 text-center text-white relative overflow-hidden">
            ...
            <div className="relative">
              ...
              <p className="mt-4 text-white/50 text-lg max-w-xl mx-auto">Join hundreds of students who trust EduManage BD.</p>
              <div className="mt-8 flex flex-col sm:flex-row gap-3 justify-center">
                <Link href="/enroll" className="px-8 py-4 bg-white text-gray-900 rounded-xl font-semibold hover:bg-gray-100 shadow-xl transition-all">Enroll Now — It&apos;s Free</Link>
                <Link href="/parent-portal" className="px-8 py-4 border border-white/20 text-white rounded-xl font-semibold hover:bg-white/10 transition-all">Parent Portal</Link>
              </div>
            </div>
          </div>
        </div>
      ...
      <footer id="contact" className="bg-gray-950 text-gray-400 pt-16 pb-8 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 pb-12 border-b border-gray-800">
            <div className="md:col-span-2">
              <div className="flex items-center gap-2.5 mb-4">
                <div className="w-8 h-8 bg-gradient-to-br from-indigo-500 to-violet-500 rounded-lg flex items-center justify-center"><GraduationCap className="w-4 h-4 text-white" /></div>
          ...
          <div className="pt-8 text-center text-xs text-gray-600">
            <p>© 2026 EduManage BD. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
